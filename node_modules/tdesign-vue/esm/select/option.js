...
import { scrollSelectedIntoView } from '../utils/dom.js';
...
var _Option = mixins(keepAnimationMixins).extend({
  name: "TOption",
  data: function data() {
    return {
      isHover: false,
  ...
  computed: {
    ...
    classes: function classes() {
      ...
      return ["".concat(prefix, "-select-option"), (_ref = {}, _defineProperty(_ref, ClASSNAMES.STATUS.disabled, this.tDisabled || this.multiLimitDisabled), _defineProperty(_ref, ClASSNAMES.STATUS.selected, this.selected), _defineProperty(_ref, ClASSNAMES.SIZE[this.tSelect && this.tSelect.size], this.tSelect && this.tSelect.size), _defineProperty(_ref, "".concat(prefix, "-select-option__hover"), this.hovering), _ref)];
    },
    ...
    show: function show() {
      ...
      if (this.tSelect.canFilter && this.tSelect.searchInput !== "") {
        return this.tSelect.filterOptions.some(function (option) {
          return get(option, _this2.tSelect.realValue) === _this2.value;
        });
      }
      ...
      if (this.tSelect.value instanceof Array) {
        if (this.tSelect.labelInValue) {
          flag = this.tSelect.value.map(function (item) {
            return get(item, _this3.tSelect.realValue);
