...
var _Select = mixins(getConfigReceiverMixins("select")).extend({
  ...
  computed: {
    classes: function classes() {
      ...
      return ["".concat(name), "".concat(prefix, "-select-polyfill"), (_ref = {}, _defineProperty(_ref, ClASSNAMES.STATUS.disabled, this.tDisabled), _defineProperty(_ref, ClASSNAMES.STATUS.active, this.visible), _defineProperty(_ref, ClASSNAMES.SIZE[this.size], this.size), _defineProperty(_ref, "".concat(prefix, "-has-prefix"), this.$scopedSlots.prefixIcon), _defineProperty(_ref, "".concat(prefix, "-no-border"), !this.bordered), _ref)];
    },
    ...
    tipsClass: function tipsClass() {
      return ["".concat(name, "__loading-tips"), _defineProperty({}, ClASSNAMES.SIZE[this.size], this.size)];
    },
    emptyClass: function emptyClass() {
      return ["".concat(name, "__empty"), _defineProperty({}, ClASSNAMES.SIZE[this.size], this.size)];
    },
    ...
    selectedSingle: function selectedSingle() {
      ...
      if (!this.multiple && (typeof this.value === "string" || typeof this.value === "number")) {
        ...
        if (this.realOptions && this.realOptions.length) {
          target = this.realOptions.filter(function (item) {
            return get(item, _this.realValue) === _this.value;
          });
        }
      ...
      var showText = get(this.value, this.realLabel);
      ...
      if (this.multiple && Array.isArray(this.value) && this.value.length) {
        return this.value.map(function (item) {
          ...
          var tmp = _this2.realOptions.filter(function (op) {
            return get(op, _this2.realValue) === item;
          });

          var valueLabel = {};
          set(valueLabel, _this2.realValue, item);
          set(valueLabel, _this2.realLabel, tmp.length ? get(tmp[tmp.length - 1], _this2.realLabel) : item);
    ...
    searchInput: function searchInput(val) {
      ...
      if (this.canFilter && val && this.creatable) {
        var tmp = this.realOptions.filter(function (item) {
          return get(item, _this5.realLabel).toString() === val;
        });
  ...
  methods: {
        ...
        if (this.multiple) {
          ...
          if (this.labelInValue) {
            var index = tempValue.map(function (item) {
              return get(item, _this6.realValue);
            }).indexOf(value);
            ...
            if (index > -1) {
              ...
              tempValue.push(this.realOptions.filter(function (item) {
                return get(item, _this6.realValue) === value;
              })[0]);
    ...
    removeTag: function removeTag(index, context) {
      ...
      var removeOption = this.realOptions.filter(function (item) {
        return get(item, _this7.realValue) === val;
      });
      var tempValue = Array.isArray(this.value) ? [].concat(this.value) : [];
    ...
    getOptions: function getOptions(option) {
      ...
      var tmp = this.realOptions.filter(function (item) {
        return get(item, _this8.realValue) === option.value && get(item, _this8.realLabel) === option.label;
      });
      ...
      if (this.labelInValue) {
        if (Array.isArray(val)) {
          ...
          var target = this.realOptions.filter(function (item) {
            return get(item, _this10.realValue) === val;
          });
    ...
    debounceOnRemote: debounce(function () {
    ...
    monitorWidth: function monitorWidth() {
      ...
      this.$nextTick(function () {
        ...
        if (_this11.popupProps && isFunction(_this11.popupProps.overlayStyle)) {
        ...
        if (_typeof(styles) === "object" && !styles.width) {
          ...
          Vue.set(_this11.defaultProps, "overlayStyle", {
    ...
    getCloseIcon: function getCloseIcon() {
      ...
      return h(CloseCircleFilledIcon, {
        "class": closeIconClass,
        "attrs": {
          "size": this.size
        },
    ...
    renderOptions: function renderOptions(options) {
      ...
      return h("ul", {
        ...
        return h("t-option", {
          "attrs": {
            "value": get(item, _this13.realValue),
            "label": get(item, _this13.realLabel),
            "content": item.content,
            "disabled": item.disabled || _this13.multiLimitDisabled(get(item, _this13.realValue))
          },
          "key": index
        });
      })]);
    ...
    initHoverindex: function initHoverindex() {
      ...
      if (!this.multiple && (typeof this.value === "string" || typeof this.value === "number")) {
        var targetIndex = Object.keys(this.hoverOptions).filter(function (i) {
          return get(_this14.hoverOptions[i], _this14.realValue) === _this14.value;
        });
        ...
        Array.isArray(this.value) && this.value.some(function (item) {
          var targetIndex = Object.keys(_this14.hoverOptions).filter(function (i) {
            return _typeof(item) === "object" && get(_this14.hoverOptions[i], _this14.realValue) === get(item, _this14.realValue) || get(_this14.hoverOptions[i], _this14.realValue) === item;
          });
