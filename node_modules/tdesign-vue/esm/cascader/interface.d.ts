...
export * from './type';
export interface CascaderContextType extends Pick<TdCascaderProps, 'size' | 'disabled' | 'checkStrictly' | 'lazy' | 'multiple' | 'filterable' | 'clearable' | 'checkProps' | 'showAllLevels' | 'max' | 'value' | 'minCollapsedNum' | 'loading' | 'valueType'> {
    treeStore: TreeStore;
    inputWidth: number;
