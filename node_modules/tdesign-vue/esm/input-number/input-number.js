...
var name = "".concat(prefix, "-input-number");
var _InputNumber = Vue.extend({
  name: "TInputNumber",
  ...
  computed: {
    ...
    reduceClasses: function reduceClasses() {
      return {
        "class": ["".concat(name, "__decrease"), _defineProperty({}, ClASSNAMES.STATUS.disabled, this.disabledReduce)]
      };
    },
    ...
    addClasses: function addClasses() {
      return {
        "class": ["".concat(name, "__increase"), _defineProperty({}, ClASSNAMES.STATUS.disabled, this.disabledAdd)]
      };
    },
    ...
    cmptWrapClasses: function cmptWrapClasses() {
      ...
      return {
        "class": [name, ClASSNAMES.SIZE[this.size], (_ref3 = {}, _defineProperty(_ref3, ClASSNAMES.STATUS.disabled, this.tDisabled), _defineProperty(_ref3, "".concat(prefix, "-is-controls-right"), this.theme === "column"), _defineProperty(_ref3, "".concat(name, "--").concat(this.theme), this.theme), _defineProperty(_ref3, "".concat(name, "--auto-width"), this.autoWidth), _ref3)]
      };
    },
