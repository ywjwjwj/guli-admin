...
import { CloseCircleFilledIcon, BrowseOffIcon, BrowseIcon } from 'tdesign-icons-vue';
import camelCase from 'lodash/camelCase';
import kebabCase from 'lodash/kebabCase';
import { getCharacterLength, omit } from '../utils/helper.js';
...
var _Input = mixins(getConfigReceiverMixins("input")).extend({
  ...
  computed: {
    ...
    inputClasses: function inputClasses() {
      ...
      return [name, ClASSNAMES.SIZE[this.size] || "", (_ref = {}, _defineProperty(_ref, ClASSNAMES.STATUS.disabled, this.tDisabled), _defineProperty(_ref, ClASSNAMES.STATUS.focused, this.focused), _defineProperty(_ref, "".concat(prefix, "-is-").concat(this.status), this.status), _defineProperty(_ref, "".concat(prefix, "-align-").concat(this.align), this.align !== "left"), _defineProperty(_ref, "".concat(prefix, "-is-disabled"), this.tDisabled), _defineProperty(_ref, "".concat(prefix, "-is-readonly"), this.readonly), _defineProperty(_ref, "".concat(name, "--focused"), this.focused), _defineProperty(_ref, "".concat(name, "--auto-width"), this.autoWidth), _ref)];
    }
  },
  watch: {
    autofocus: {
  ...
  render: function render(h) {
    ...
    var classes = [this.inputClasses, this.inputClass, (_ref2 = {}, _defineProperty(_ref2, "".concat(name, "--prefix"), prefixIcon || labelContent), _defineProperty(_ref2, "".concat(name, "--suffix"), suffixIcon || suffixContent), _ref2)];
    var inputNode = h("div", {
      "class": classes,
      "on": _objectSpread({
      ...
      "class": ["".concat(name, "__suffix"), "".concat(name, "__suffix-icon"), _defineProperty({}, "".concat(name, "__clear"), this.showClear)]
    }, [suffixIcon]) : null]);
