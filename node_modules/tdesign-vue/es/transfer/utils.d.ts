...
declare function findTopNode(vm: Vue): Vue;
...
declare function getLeefCount(nodes: Array<TreeNode>): number;
export { findTopNode, getTransferListOption, getDataValues, getTransferData, cloneTreeWithFilter, filterTransferData, getLeefCount, };
