...
export declare type TdCSSProperties = Partial<CSSStyleDeclaration>;
...
export declare type DisableDate = Array<DateValue> | DisableDateObj | ((date: Date | string) => boolean);
