...
var GestureController = /*#__PURE__*/function () {
  function GestureController(_ref) {
    ...
    this.Hammer = _hammerjs["default"];
    this.hammer = new _hammerjs["default"](dom, hammerOptions);
    this.dom = dom;
    this.gesture = gesture;
    this.options = (0, _common.deepMix)({}, defaultOptions, options);
  ...
  _proto.bindEvents = function bindEvents() {
    ...
    var _loop = function _loop(key) {
      if (['touchstart', 'touchmove', 'touchend'].indexOf(key) !== -1) {
        ...
        (0, _common.addEventListener)(dom, key, bindEvent);
  ...
  _proto.getEventPositionRecords = function getEventPositionRecords(event, _isOrigin) {
  ...
  _proto.destroy = function destroy() {
    ...
    for (var key in this._unbindEvent) {
      ...
      (0, _common.removeEventListener)(this.dom, key, event);
    }
  };
