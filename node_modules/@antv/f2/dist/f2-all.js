(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function convertPoints$1(ev, canvas) {
    ...
    function createEvent(event, chart) {
      ...
      var points = convertPoints$1(event, canvas); // touchend会没有points
        ...
        draw: function draw(cfg, container) {
          ...
          if (nextPoints) {
            ...
            if (shapeType === 'pyramid') {
              polygonPoints.push(getMiddlePoint$1(points[2], points[3]));
            } else {
    ...
    var RegionFilter = /*#__PURE__*/function (_GuideBase) {
      _inheritsLoose$3(RegionFilter, _GuideBase);
      ...
      _proto.render = function render(coord) {
        ...
        geoms.map(function (geom) {
          ...
          children.map(function (c) {
            if (c.get('isShape')) {
              var type = c.get('type');
              var attrs = mix$1({}, c.get('attrs'), style);
    ...
    */
    ...
    function getLimitRange(data, scale) {
      ...
      if (type === 'linear') {
        ...
        each$1(values$1, function (v, i) {
          values$1[i] = toTimeStamp$1(v);
        });
    ...
    var Controller = /*#__PURE__*/function () {
      ...
      _proto.draw = function draw() {
        var chart = this.chart,
            ...
            cfg = this.cfg;
        if (!cfg) return;
        var labelCfg = mix$1({}, DEFAULT_CFG, cfg);
        var geom = chart.get('geoms')[0];
        var shapes = geom.get('container').get('children');
        shapes.forEach(function (shape) {
          var origin = shape.get('origin');
    ...
    var TOUCH_EVENTS$1 = ['touchstart', 'touchmove', 'touchend'];
    ...
    var Interaction = /*#__PURE__*/function () {
      ...
      _proto.getDefaultCfg = function getDefaultCfg() {
        return {
          startEvent: TOUCH_EVENTS$1[0],
          processEvent: TOUCH_EVENTS$1[1],
          endEvent: TOUCH_EVENTS$1[2],
          resetEvent: null
        };
      };
      ...
      _proto._bindEvent = function _bindEvent(eventName, method) {
        ...
        if (eventName) {
          if (TOUCH_EVENTS$1.indexOf(eventName) !== -1) {
      ...
      _proto._clearTouchEvent = function _clearTouchEvent(eventName, method) {
        ...
        if (eventName && TOUCH_EVENTS$1.indexOf(eventName) !== -1) {
    ...
    var PieSelect = /*#__PURE__*/function (_Interaction) {
      _inheritsLoose$3(PieSelect, _Interaction);
    ...
    var IntervalSelect = /*#__PURE__*/function (_Interaction) {
      _inheritsLoose$3(IntervalSelect, _Interaction);
      ...
      _proto._selectShapes = function _selectShapes(selectedShape, unSelectedShapes) {
        ...
        each$1(unSelectedShapes, function (child) {
        ...
        if (this.selectAxis) {
          ...
          var axisShape;
          each$1(frontPlot.get('children').concat(backPlot.get('children')), function (s) {
    ...
    function beforeGeomInit(chart) {
      ...
      var fields = [];
      each$1(colDefs, function (def, key) {
    ...
    function convertPoints(point) {
      var x = point.x,
          ...
          clientY = point.clientY; // 小程序环境会有x,y
    ...
    function _handleMove(e) {
      ...
      if (TOUCH_EVENTS.indexOf(e.type) !== -1) {
        ...
        var deltaLastPoint = convertPoints(lastPoint);
        var deltaCurrentPoint = convertPoints(currentPoint);
    ...
    function _doMove(deltaX, deltaY) {
      ...
      if (directionEnabled(mode, 'y') && deltaY !== 0) {
        ...
        var yScales = chart.getYScales();
        each$1(yScales, function (yScale) {
          var yField = yScale.field;
    ...
    function _handleLinearScale(scale, delta, range, flag) {
      ...
      if (limitRange[field] && !isNil$1(limitRange[field].min) && newMin <= limitRange[field].min) {
        newMin = limitRange[field].min;
        newMax = max - min + newMin;
      }

      if (limitRange[field] && !isNil$1(limitRange[field].max) && newMax >= limitRange[field].max) {
    ...
    var Swipe = /*#__PURE__*/function (_Interaction) {
      _inheritsLoose$3(Swipe, _Interaction);
      ...
      function Swipe(cfg, chart) {
        ...
        self.mode = 'x';
        mix$1(self, UpdateScaleMixin, MoveMixin);
        return _this;
      }
    ...
    var Pan = /*#__PURE__*/function (_Interaction) {
      _inheritsLoose$3(Pan, _Interaction);
      ...
      function Pan(cfg, chart) {
        ...
        mix$1(_assertThisInitialized(_this), UpdateScaleMixin, MoveMixin);
        return _this;
      }
    ...
    var Pinch = /*#__PURE__*/function (_Interaction) {
      _inheritsLoose$3(Pinch, _Interaction);
    ...
    Chart.plugins.register([Tooltip, Legend, Guide, Animation, ScrollBar, PieLabel, intervalLabel$1]);
    var indexAll = {
      Global: Global,
      Chart: Chart,
      Shape: Shape$1,
