...
import vuxField from 'src/components/form/field.vue'

_vux['vuxField'] = vuxField
...
import vuxInlineXSwitch from 'src/components/inline-x-switch/index.vue'

_vux['vuxInlineXSwitch'] = vuxInlineXSwitch
...
import vuxVArea from 'src/components/v-chart/v-area.vue'

_vux['vuxVArea'] = vuxVArea
import vuxVAxis from 'src/components/v-chart/v-axis.vue'

_vux['vuxVAxis'] = vuxVAxis
import vuxVBar from 'src/components/v-chart/v-bar.vue'

_vux['vuxVBar'] = vuxVBar
import vuxVChart from 'src/components/v-chart/v-chart.vue'

_vux['vuxVChart'] = vuxVChart
import vuxVGuide from 'src/components/v-chart/v-guide.vue'

_vux['vuxVGuide'] = vuxVGuide
...
import vuxVLegend from 'src/components/v-chart/v-legend.vue'

_vux['vuxVLegend'] = vuxVLegend
import vuxVLine from 'src/components/v-chart/v-line.vue'

_vux['vuxVLine'] = vuxVLine
import vuxVPie from 'src/components/v-chart/v-pie.vue'

_vux['vuxVPie'] = vuxVPie
import vuxVPoint from 'src/components/v-chart/v-point.vue'

_vux['vuxVPoint'] = vuxVPoint
import vuxVScale from 'src/components/v-chart/v-scale.vue'

_vux['vuxVScale'] = vuxVScale
import vuxVTooltip from 'src/components/v-chart/v-tooltip.vue'

_vux['vuxVTooltip'] = vuxVTooltip
...
import vuxXForm from 'src/components/x-form/form.vue'

_vux['vuxXForm'] = vuxXForm
