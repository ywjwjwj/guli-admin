...
var _helper = require("../interaction/helper");
...
function init(chart) {
  ...
  chart.scrollBar = function (cfg) {
    if (cfg === true) {
      cfg = DEFAULT_CFG;
    } else if ((0, _common.isObject)(cfg)) {
      cfg = (0, _common.deepMix)({}, DEFAULT_CFG, cfg);
    }
...
function afterGeomDraw(chart) {
  ...
  if ((0, _common.directionEnabled)(mode, 'x')) {
    ...
    if (!xLimitRange) {
      xLimitRange = (0, _helper.getLimitRange)(data, xScale);
      limitRange[xScale.field] = xLimitRange;
    }

    var currentRange = (0, _helper.getFieldRange)(xScale, xLimitRange, xScale.type);
  ...
  if ((0, _common.directionEnabled)(mode, 'y')) {
    ...
    if (!yLimitRange) {
      yLimitRange = (0, _helper.getLimitRange)(data, yScale);
      limitRange[yScale.field] = yLimitRange;
    }

    var _currentRange = (0, _helper.getFieldRange)(yScale, yLimitRange, yScale.type);
