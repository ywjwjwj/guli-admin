...
import { CloseIcon, InfoCircleFilledIcon, CheckCircleFilledIcon, ErrorCircleFilledIcon } from 'tdesign-icons-vue';
...
var _Dialog = mixins(ActionMixin, getConfigReceiverMixins("dialog")).extend({
  ...
  render: function render() {
    ...
    var ctxClass = ["".concat(name, "__ctx"), _defineProperty({}, "".concat(prefix, "-dialog__ctx--fixed"), this.mode === "modal")];
    return h("transition", {
      "attrs": {
        "duration": 300,
