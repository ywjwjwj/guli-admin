...
function getNodeStatusClass(node, CLASSNAMES, cascaderContext) {
  ...
  return [(_ref = {}, _defineProperty(_ref, CLASSNAMES.STATUS.selected, !isDisabled && isSelected), _defineProperty(_ref, CLASSNAMES.STATUS.expanded, !isDisabled && expandedActive), _defineProperty(_ref, CLASSNAMES.STATUS.disabled, isDisabled), _ref)];
}
function getCascaderItemClass(prefix, node, CLASSNAMES, cascaderContext) {
  var _ref2;

  var size = cascaderContext.size;
  return ["".concat(prefix, "-cascader__item")].concat(_toConsumableArray(getNodeStatusClass(node, CLASSNAMES, cascaderContext)), [(_ref2 = {}, _defineProperty(_ref2, "".concat(prefix, "-cascader__item--with-icon"), !!node.children), _defineProperty(_ref2, "".concat(prefix, "-cascader__item--leaf"), node.isLeaf()), _defineProperty(_ref2, CLASSNAMES.SIZE[size], !!size), _ref2)]);
}
...
export { getCascaderItemClass, getCascaderItemIconClass, getLabelIsEllipsis, getNodeStatusClass };
