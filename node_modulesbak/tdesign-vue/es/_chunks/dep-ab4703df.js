...
import { c as createCommonjsModule, a as commonjsGlobal } from './dep-e3c17631.js';
import { EPickerCols } from '../time-picker/interface.js';
import { panelColProps } from '../time-picker/panel/props.js';
import { componentName } from '../time-picker/constant.js';
import { prefix } from '../config.js';

var customParseFormat = createCommonjsModule(function (module, exports) {
  !function (t, e) {
    "object" == 'object' && "undefined" != 'object' ? module.exports = e() : "function" == typeof undefined && undefined.amd ? undefined(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).dayjs_plugin_customParseFormat = e();
...
var name = "".concat(prefix, "-time-picker-pane-col");
dayjs.extend(customParseFormat);
var PanelCol = Vue.extend({
  name: name,
  data: function data() {
    return {
  ...
  methods: {
    ...
    generateColRows: function generateColRows(col) {
      ...
      return this.generateColTime(col).map(function (el) {
        ...
        var classNames = ["".concat(componentName, "__panel-body-scroll-item"), (_ref = {}, _defineProperty(_ref, "".concat(prefix, "-is-disabled"), !_this3.timeItemCanUsed(col, el)), _defineProperty(_ref, "".concat(prefix, "-is-current"), isCurrent), _ref)];
        return h("li", {
          "class": classNames,
          "on": {
...
export { PanelCol as P, customParseFormat as c };
//# sourceMappingURL=dep-ab4703df.js.map
