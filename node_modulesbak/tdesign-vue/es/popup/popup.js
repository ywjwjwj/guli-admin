...
var Popup = Vue.extend({
  ...
  computed: {
    overlayClasses: function overlayClasses() {
      ...
      var base = ["".concat(name, "__content"), (_ref = {}, _defineProperty(_ref, "".concat(name, "__content--text"), this.content === "string"), _defineProperty(_ref, "".concat(name, "__content--arrow"), this.showArrow), _defineProperty(_ref, ClASSNAMES.STATUS.disabled, this.disabled), _ref)];
