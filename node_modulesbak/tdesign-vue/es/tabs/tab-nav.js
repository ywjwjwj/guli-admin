...
var TTabNav = Vue.extend({
  ...
  computed: {
    ...
    iconBaseClass: function iconBaseClass() {
      ...
      return _ref = {}, _defineProperty(_ref, "".concat(prefix, "-tabs__btn"), true), _defineProperty(_ref, "".concat(prefix, "-size-m"), this.size === "medium"), _defineProperty(_ref, "".concat(prefix, "-size-l"), this.size === "large"), _ref;
    },
    leftIconClass: function leftIconClass() {
      return _objectSpread(_defineProperty({}, "".concat(prefix, "-tabs__btn--left"), true), this.iconBaseClass);
    },
    rightIconClass: function rightIconClass() {
      return _objectSpread(_defineProperty({}, "".concat(prefix, "-tabs__btn--right"), true), this.iconBaseClass);
    },
    addIconClass: function addIconClass() {
      return _objectSpread(_defineProperty({}, "".concat(prefix, "-tabs__add-btn"), true), this.iconBaseClass);
    },
    navContainerClass: function navContainerClass() {
      var _ref2;

      return _ref2 = {}, _defineProperty(_ref2, "".concat(prefix, "-tabs__nav-container"), true), _defineProperty(_ref2, "".concat(prefix, "-tabs__nav--card"), this.theme === "card"), _defineProperty(_ref2, "".concat(prefix, "-is-").concat(this.placement), true), _defineProperty(_ref2, "".concat(prefix, "-is-addable"), this.theme === "card" && this.addable), _ref2;
    },
    navScrollContainerClass: function navScrollContainerClass() {
      var _ref3;

      return _ref3 = {}, _defineProperty(_ref3, "".concat(prefix, "-tabs__nav-scroll"), true), _defineProperty(_ref3, "".concat(prefix, "-is-scrollable"), this.canToLeft || this.canToRight), _ref3;
    },
    navsWrapClass: function navsWrapClass() {
      return ["".concat(prefix, "-tabs__nav-wrap"), "".concat(prefix, "-is-smooth"), _defineProperty({}, "".concat(prefix, "-is-vertical"), this.placement === "left" || this.placement === "right")];
    },
  ...
  methods: {
    ...
    calculateNavBarStyle: function calculateNavBarStyle() {
      ...
      var getNavBarStyle = function getNavBarStyle() {
        ...
        for (; i < _this6.navs.length; i++) {
          ...
          offset += ((_this6$navs$i$compone2 = _this6.navs[i].componentInstance) === null || _this6$navs$i$compone2 === void 0 ? void 0 : (_this6$navs$i$compone3 = _this6$navs$i$compone2.$el) === null || _this6$navs$i$compone3 === void 0 ? void 0 : _this6$navs$i$compone3["client".concat(firstUpperCase(sizePropName))]) || 0;
        }

        if (!_this6.navs[i]) return {};
        return _ref5 = {}, _defineProperty(_ref5, offsetPropName, "".concat(offset, "px")), _defineProperty(_ref5, sizePropName, "".concat(((_this6$navs$i$compone4 = _this6.navs[i].componentInstance) === null || _this6$navs$i$compone4 === void 0 ? void 0 : (_this6$navs$i$compone5 = _this6$navs$i$compone4.$el) === null || _this6$navs$i$compone5 === void 0 ? void 0 : _this6$navs$i$compone5["client".concat(firstUpperCase(sizePropName))]) || 0, "px")), _ref5;
      };
    ...
    renderArrows: function renderArrows() {
      ...
      }, [h(ChevronRightIcon)]) : null]), this.theme === "card" && this.addable ? h("div", {
