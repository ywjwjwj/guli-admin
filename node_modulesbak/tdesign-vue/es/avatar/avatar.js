...
var _Avatar = Vue.extend({
  ...
  render: function render() {
    ...
    var avatarClass = ["".concat(name), ClASSNAMES.SIZE[this.sizeValue], (_ref = {}, _defineProperty(_ref, "".concat(name, "--circle"), shape === "circle"), _defineProperty(_ref, "".concat(name, "--round"), shape === "round"), _defineProperty(_ref, "".concat(name, "__icon"), !!isIconOnly), _ref)];
    content = h("span", {
      "ref": "avatarChild",
