...
var TREE_NAME = "".concat(config.prefix, "-tree");
var TREE_NODE_NAME = "".concat(config.prefix, "-tree-node");
var FX = {
  treeNode: "".concat(config.prefix, "-tree-toggle")
};
var tree = "".concat(config.prefix, "-tree");
var CLASS_NAMES = {
  icon: "".concat(config.prefix, "-icon"),
  folderIcon: "".concat(config.prefix, "-folder-icon"),
  actived: "".concat(config.prefix, "-is-active"),
  disabled: "".concat(config.prefix, "-is-disabled"),
  treeIconRight: "".concat(config.prefix, "-icon-arrow-right"),
  treeIconDown: "".concat(config.prefix, "-icon-arrow-down"),
  tree: tree,
...
exports.TREE_NODE_NAME = TREE_NODE_NAME;
