...
var _FormItem = utils_mixins["default"](configProvider_configReceiver["default"]("form")).extend({
  name: "TFormItem",
  ...
  computed: {
    ...
    innerRules: function innerRules() {
      ...
      return get__default["default"](parent === null || parent === void 0 ? void 0 : parent.rules, this.name) || get__default["default"](parent === null || parent === void 0 ? void 0 : parent.rules, pRuleName) || [];
    },
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return form_formModel.validate(_this3.value, rules);
              ...
              case 4:
                ...
                errorList = r.filter(function (item) {
                  ...
                  Object.keys(item).forEach(function (key) {
                    if (typeof item.message === "undefined" && _this3.errorMessages[key]) {
                      var compiled = lodashTemplate__default["default"](_this3.errorMessages[key]);
                ...
                return _context.abrupt("return", _defineProperty__default["default"]({}, _this3.name, errorList.length === 0 ? true : r));
    ...
    getDefaultIcon: function getDefaultIcon() {
      ...
      /* SUCCESS */
        ...
        return resultIcon(tdesignIconsVue.CheckCircleFilledIcon);
      }
      ...
      if (list && list[0]) {
        ...
        }[type] || tdesignIconsVue.CheckCircleFilledIcon;
