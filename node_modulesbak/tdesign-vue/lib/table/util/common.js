...
function getTitle(vm, column, colIndex) {
  ...
  if (isFunction__default["default"](column.title)) {
    result = column.title(vm.$createElement, {
      col: column,
      colIndex: colIndex
    });
  } else if (isString__default["default"](column.title)) {
    result = vm.$scopedSlots[column.title] ? vm.$scopedSlots[column.title](null) : column.title;
  } else if (isFunction__default["default"](column.render)) {
...
function getCell(vm, p) {
  ...
  if (isFunction__default["default"](col.cell)) {
    result = col.cell(vm.$createElement, _objectSpread({}, p));
  } else if (isString__default["default"](col.cell)) {
    result = vm.$scopedSlots[col.cell] ? vm.$scopedSlots[col.cell](p) : row[col.colKey];
  } else if (isFunction__default["default"](col.render)) {
    result = col.render(vm.$createElement, _objectSpread({
      type: "cell"
    }, p));
  }
