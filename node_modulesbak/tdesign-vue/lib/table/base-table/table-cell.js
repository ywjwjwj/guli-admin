...
var ELLIPSIS_CLASS_NAME = "".concat(config.prefix, "-text-ellipsis");
var overlayStyle = {
  width: "100%",
  maxWidth: "400px",
  wordBreak: "break-all"
...
var TableCell = Vue__default["default"].extend({
  ...
  render: function render(h) {
    ...
    if (ellipsis && this.isCutOff) {
      ...
      newCellContent = h(popup_index.Popup, {
    ...
    return h("td", helper.helper([{}, tdAttrs]), [newCellContent]);
  },
...
exports.ELLIPSIS_CLASS_NAME = ELLIPSIS_CLASS_NAME;
