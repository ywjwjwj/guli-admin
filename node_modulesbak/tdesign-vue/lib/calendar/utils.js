...
var createMonthCellsData = function createMonthCellsData(year, month, firstDayOfWeek, curDate, format) {
  ...
  var end = dayjs__default["default"]("".concat(year, "-").concat(month)).endOf("month").toDate();
  ...
  for (var _i = 0; _i < days; _i++) {
    ...
    arr.push(createCellData(0, curDate.isSame(dayjs__default["default"](_date)), _date, num));
