...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    var keys = get__default["default"](tree, "config.keys") || {};
    ...
    this.value = spec[propValue] || uniqueId__default["default"](prefix);
  ...
  _createClass__default["default"](TreeNode, [{
    key: "initChecked",
    ...
    value: function isDisabled() {
      ...
      var treeDisabled = get__default["default"](this, "tree.config.disabled");
      return !!(treeDisabled || this.disabled);
    }
  }, {
    key: "isExpandMutex",
    value: function isExpandMutex() {
      return !!(get__default["default"](this, "tree.config.expandMutex") || this.expandMutex);
    }
  }, {
    key: "isActivable",
    value: function isActivable() {
      return !!(get__default["default"](this, "tree.config.activable") || this.activable);
    }
  }, {
    key: "isCheckable",
    value: function isCheckable() {
      return !!(get__default["default"](this, "tree.config.checkable") || this.checkable);
    }
  }, {
    key: "isActived",
    ...
    value: function setExpanded(expanded, opts) {
      ...
      if (expanded) {
        ...
        if (get__default["default"](tree, "config.expandParent")) {
